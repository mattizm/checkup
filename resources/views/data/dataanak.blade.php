      ...
      <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
        ...
        <thead>
          ...
          <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
            ...
            <th class="min-w-125px">Goldar</th>
        ...
        <tbody class="text-gray-600 fw-semibold">
          @forelse ($childs as $key => $value)
            ...
            <tr>
              ...
              <!--begin::Number=-->
              <td>
                <div class="badge badge-light fw-bold">{{ $childs->firstItem() + $key }}</div>
              </td>
              <!--end::Number=-->
              <!--begin::User=-->
              <td class="d-flex align-items-center">
                ...
                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                  @if ($value->foto)
                    <img src="{{ asset('avatar/' . $value->foto) }}" alt="">
                  @else
                ...
                <div class="d-flex flex-column">
                  <p class="text-gray-800 text-hover-primary mb-1">{{ $value->nama }}</p>
              ...
              <!--end::Two step=-->
              <!--begin::Joined-->
              <td class="text-center">{{ $value->tempat_lahir.' '.\Carbon\Carbon::parse($value->tanggal_lahir)->format('d F Y') }}</td>
              <!--begin::Joined-->
              <!--begin::Action=-->
              <td class="text-end">
                ...
                <div
                  ...
                  <div class="menu-item px-3">
                    <a href="#" class="menu-link px-3">Lihat Data Anak</a>
                  </div>
                  <!--end::Menu item-->
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
          ...
          @empty
            <tr>
              <td class="text-center text-danger" colspan="9">Data Tidak Di temukan</td>
            </tr>
          @endforelse
        </tbody>
        <!--end::Table body-->
