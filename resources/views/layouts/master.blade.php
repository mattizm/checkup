...
<html lang="id">
    ...
    <meta property="og:title" content="@yield('title') - {{ config('matt.nama_app') }}" />
    <meta property="og:url" content="{{ config('app.url') }}" />
    <meta property="og:site_name" content="{{ config('matt.nama_app') }}" />
                    ...
                    <!--end:Menu link-->
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-lg-5">
									<!--begin::Menu- wrapper-->
									<div class="btn btn-icon btn-custom btn-icon-gray-700 btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom">
										<i class="fonticon-calendar fs-2 text-gray-600"></i>
									</div>
									<!--begin::Menu-->
								...
								<div class="app-navbar-item ms-1 ms-lg-5">
									<!--begin::Menu- wrapper-->
									<div class="btn btn-icon btn-custom btn-icon-gray-700 btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom">
										<i class="fonticon-layers fs-2 text-gray-600"></i>
									</div>
									<!--begin::Menu-->
								...
								<div class="app-navbar-item ms-1 ms-lg-5">
									<!--begin::Menu wrapper-->
									<div class="btn btn-icon btn-custom btn-icon-gray-700 btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative" id="kt_drawer_chat_toggle">
										<i class="fonticon-alarm fs-2 text-gray-600"></i>
									</div>
									<!--end::Menu wrapper-->
								</div>
								<!--end::Chat-->
